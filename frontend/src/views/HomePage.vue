      ...
      <el-container style=" text-align: center;padding: 30px;">
        ...
        <div class="ranking">
          ...
          <div class="row d-flex justify-content-center">
            <div class="card" style="width: 14rem;height: 16rem ;" v-for="(phot, index) in producthotsale"
              ...
              <div class="card-body">
                <p class="card-text">
                  {{ phot[0]?.productName.length <= 20 ? phot[0]?.productName : phot[0]?.productName.substring(0, 20) }}
                    ...
                    ">
                      <span style="text-decoration: line-through; padding-right: 20px; font-size: 0.8em;">${{
                        phot[0]?.price
        ...
        <div class="ranking">
          <h1>新上架遊戲</h1>
          <div class="row d-flex justify-content-center">
            <div class="card" style="width: 14rem;height: 16rem ;" v-for="(pnew, index) in productnewrelease"
              :key="index" @click="SeeProductInfor(pnew[0])">
